...
public class SellerRegistrationActivity extends AppCompatActivity {
    ...
    private void registerSeller() {
        ...
        if (!name.equals("") && !phone.equals("") && !email.equals("") && !password.equals("") && !address.equals("")){
            loadingBar.setTitle("Создание аккаунта продавца");
                                ...
                                rootRef.child("Sellers").child(sid).updateChildren(sellerMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                loadingBar.dismiss();
                                                Toast.makeText(SellerRegistrationActivity.this, "Регистрация прошла успешно", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Пожалуйста, закончите заполнение формы", Toast.LENGTH_SHORT).show();
        }
    }
}