        ...
        FirebaseRecyclerAdapter<Products, ItemViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ItemViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ItemViewHolder holder, int position, @NonNull Products model) {
                        ...
                        holder.txtProductState.setText("Статус: " + model.getProductState());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle("Вы хотите, чтобы этот продукт был удален? Вы уверены?");
        ...
        unverifiedProductsRef.child(productID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(SellerHomeActivity.this, "Этот товар был удален успешно", Toast.LENGTH_LONG).show();
