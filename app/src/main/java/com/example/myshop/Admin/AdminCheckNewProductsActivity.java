                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle("Вы хотите, чтобы этот продукт был одобрен? Вы уверены?");
    ...
    private void ChangeProductState(String productID) {
        unverifiedProductsRef.child(productID)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(AdminCheckNewProductsActivity.this, "Этот товар был одобрен, и теперь он доступен для продажи у продавца", Toast.LENGTH_LONG).show();
            }
        });
    }
}