                    ...
                    if(usersData.getPhone().equals(phone)){
                        if(usersData.getPassword().equals(password)){
                            if (parentDbName.equals("Admins")){
                                Toast.makeText(LoginActivity.this, "Добро пожаловать, Админ, вы успешно вошли в систему...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(LoginActivity.this, "Некорректный пароль", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                else{
