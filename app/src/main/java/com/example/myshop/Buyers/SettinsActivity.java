...
public class SettinsActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode==RESULT_OK && data!=null){
            ...
            Toast.makeText(this, "Ошибка, повторите попытку", Toast.LENGTH_SHORT).show();
    ...
    private void userInfoSaved() {
        if (TextUtils.isEmpty(fullNameEditText.getText().toString())){
            ...
            Toast.makeText(this, "Адрес обязательно", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(userPhoneEditText.getText().toString())){
            Toast.makeText(this, "Телефон обязательно", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadImage() {
        ...
        progressDialog.setMessage("Пожалуйста подождите, пока мы обновляем информацию в твоем аккаунте");
